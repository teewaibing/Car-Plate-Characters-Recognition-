...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True:
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgOriginalScene, p2fRectPoints[0].astype(int), p2fRectPoints[1].astype(int), Main.SCALAR_RED, 2)         # draw 4 red lines
            cv2.line(imgOriginalScene, p2fRectPoints[1].astype(int), p2fRectPoints[2].astype(int), Main.SCALAR_RED, 2)
            cv2.line(imgOriginalScene, p2fRectPoints[2].astype(int), p2fRectPoints[3].astype(int), Main.SCALAR_RED, 2)
            cv2.line(imgOriginalScene, p2fRectPoints[3].astype(int), p2fRectPoints[0].astype(int), Main.SCALAR_RED, 2)
